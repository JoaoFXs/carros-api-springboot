...
public class CarrosAPITest {
    ...
    private ResponseEntity<CarroDTO> getCarro(String url) {
        return
                rest.withBasicAuth("jfelixy","senha123").getForEntity(url, CarroDTO.class);
    }

    private ResponseEntity<List<CarroDTO>> getCarros(String url) {
        return rest.withBasicAuth("jfelixy","senha123").exchange(
                url,
                HttpMethod.GET,
                null,
    ...
    public void testSave() {
        ...
        // Insert
        ResponseEntity response = rest.withBasicAuth("admin","admin123").postForEntity("/api/v1/carros", carro, null);
